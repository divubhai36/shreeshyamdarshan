...
export default function SubCategory() {
  ...
  return (
    <div className="min-h-screen bg-brand-accent/30">
      <Header />
      ...
      <main className="pt-20 lg:pt-24 pb-10 container mx-auto px-4 lg:px-8 max-w-7xl">
        ...
        {sections.length > 0 && (
          <div className="relative mb-6 lg:mb-10 group/slider">
            {/* Slider Buttons */}
            <button
            ...
            <div
              ref={sliderRef}
              className="flex gap-4 lg:gap-8 overflow-x-auto pb-6 snap-x no-scrollbar scroll-smooth px-2"
            >
              {sections.map((section, idx) => (
                ...
                >
                  <div className="w-14 h-14 md:w-16 md:h-16 lg:w-24 lg:h-24 rounded-full overflow-hidden border-2 border-white ring-1 ring-brand-primary/5 group-hover:ring-brand-secondary transition-all shadow-md bg-brand-primary">
                    {/* <img
                      src={section.image}
                      alt={section.name}
                  ...
                  <span className="text-[7px] lg:text-[10px] font-bold tracking-widest text-brand-primary/60 text-center uppercase group-hover:text-brand-secondary transition-all max-w-[70px] lg:max-w-[100px] leading-tight">
                    {section.name}
                  </span>
                </motion.div>
              ))}
