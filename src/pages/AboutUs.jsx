    ...
    <div className="min-h-screen bg-brand-accent pb-12 lg:pb-20 text-left">
        ...
        <div className="container mx-auto px-4 max-w-7xl">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
              ...
              <motion.div
                ...
                className="relative"
              >
                 <div className="aspect-[4/5] rounded-[40px] lg:rounded-[60px] overflow-hidden shadow-2xl border-2 border-white">
                    <img src="/images/poshak-1.jpg" alt="Devotion" className="w-full h-full object-cover" />
                 </div>
      ...
      <section className="py-16 lg:py-24 bg-brand-primary text-white text-center overflow-hidden">
         <div className="container mx-auto px-4 max-w-7xl relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
               <motion.div whileHover={{ y: -5 }} className="bg-white/5 p-10 lg:p-14 rounded-[30px] lg:rounded-[50px] border border-white/5 backdrop-blur-xl group hover:border-brand-secondary/50 transition-all">
      ...
      <section className="py-20 lg:py-32 container mx-auto px-4 text-center max-w-7xl">
         <motion.div
           ...
           viewport={{ once: true }}
           className="bg-brand-secondary p-10 lg:p-20 rounded-[40px] lg:rounded-[60px] text-white shadow-2xl relative overflow-hidden text-center"
         >
            <div className="absolute inset-0 opacity-10 bg-[url('/images/hero_3.jpg')] bg-cover bg-center mix-blend-overlay"></div>
            <div className="relative z-10 space-y-8 lg:space-y-12 text-center text-center">
               ...
               <div className="text-center">
                  <Link
                    to="/"
                    className="inline-flex items-center gap-3 px-6 py-3 lg:px-14 lg:py-6 bg-white text-brand-secondary font-bold text-xs lg:text-base uppercase tracking-widest rounded-full hover:shadow-2xl hover:scale-105 transition-all duration-500 shadow-xl"
                  >
