  ...
  return (
    <div className="max-w-6xl mx-auto text-left">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
        {[
          { title: "Total Categories", count: "...", icon: "lucide:folder", color: "text-blue-500", bg: "bg-blue-500/10" },
          { title: "Sub Categories", count: "...", icon: "lucide:layers", color: "text-purple-500", bg: "bg-purple-500/10" },
          { title: "Products Online", count: "...", icon: "lucide:shopping-bag", color: "text-emerald-500", bg: "bg-emerald-500/10" },
          { title: "Pending Reviews", count: "...", icon: "lucide:star", color: "text-amber-500", bg: "bg-amber-500/10" },
        ].map((stat, i) => (
